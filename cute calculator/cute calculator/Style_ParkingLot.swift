//
//  Style_ParkingLot.swift
//  cute calculator
//
//  Created by HSIAO JENHAO on 2017-06-14.
...
class Style_ParkingLot: UIViewController {
    ...
    var LabelFontAndSize = UIFont(name: "Overpass", size: 75)
    var LabelShowDetailFontAndSize = UIFont(name: "Overpass", size: 25)
    ...
    override func viewDidLoad() {
        ...
        ButtonNumber0.setImage(UIImage(named:"Style03-ParkingLot_Button0_normal"), for: .normal)
        ButtonNumber0.setImage(UIImage(named:"Style03-ParkingLot_Button0_highlighted"), for: .highlighted)
        ...
        ButtonDel.setImage(UIImage(named:"Style03-ParkingLot_ButtonDel_normal"), for: .normal)
        ButtonDel.setImage(UIImage(named:"Style03-ParkingLot_ButtonDel_highlighted"), for: .highlighted)
        ...
        ButtonPoint.setImage(UIImage(named:"Style03-ParkingLot_ButtonPoint_normal"), for: .normal)
        ButtonPoint.setImage(UIImage(named:"Style03-ParkingLot_ButtonPoint_highlighted"), for: .highlighted)
        ...
        ButtonEqual.setImage(UIImage(named:"Style03-ParkingLot_ButtonEqual_normal"), for: .normal)
        ButtonEqual.setImage(UIImage(named:"Style03-ParkingLot_ButtonEqual_highlighted"), for: .highlighted)
        ...
        ButtonNumber1.setImage(UIImage(named:"Style03-ParkingLot_Button1_normal"), for: .normal)
        ButtonNumber1.setImage(UIImage(named:"Style03-ParkingLot_Button1_highlighted"), for: .highlighted)
        ...
        ButtonNumber2.setImage(UIImage(named:"Style03-ParkingLot_Button2_normal"), for: .normal)
        ButtonNumber2.setImage(UIImage(named:"Style03-ParkingLot_Button2_highlighted"), for: .highlighted)
        ...
        ButtonNumber3.setImage(UIImage(named:"Style03-ParkingLot_Button3_normal"), for: .normal)
        ButtonNumber3.setImage(UIImage(named:"Style03-ParkingLot_Button3_highlighted"), for: .highlighted)
        ...
        ButtonAddition.setImage(UIImage(named:"Style03-ParkingLot_ButtonAdd_normal"), for: .normal)
        ButtonAddition.setImage(UIImage(named:"Style03-ParkingLot_ButtonAdd_highlighted"), for: .highlighted)
        ...
        ButtonNumber4.setImage(UIImage(named:"Style03-ParkingLot_Button4_normal"), for: .normal)
        ButtonNumber4.setImage(UIImage(named:"Style03-ParkingLot_Button4_highlighted"), for: .highlighted)
        ...
        ButtonNumber5.setImage(UIImage(named:"Style03-ParkingLot_Button5_normal"), for: .normal)
        ButtonNumber5.setImage(UIImage(named:"Style03-ParkingLot_Button5_highlighted"), for: .highlighted)
        ...
        ButtonNumber6.setImage(UIImage(named:"Style03-ParkingLot_Button6_normal"), for: .normal)
        ButtonNumber6.setImage(UIImage(named:"Style03-ParkingLot_Button6_highlighted"), for: .highlighted)
        ...
        ButtonSubtraction.setImage(UIImage(named:"Style03-ParkingLot_ButtonSub_normal"), for: .normal)
        ButtonSubtraction.setImage(UIImage(named:"Style03-ParkingLot_ButtonSub_highlighted"), for: .highlighted)
        ...
        ButtonNumber7.setImage(UIImage(named:"Style03-ParkingLot_Button7_normal"), for: .normal)
        ButtonNumber7.setImage(UIImage(named:"Style03-ParkingLot_Button7_highlighted"), for: .highlighted)
        ...
        ButtonNumber8.setImage(UIImage(named:"Style03-ParkingLot_Button8_normal"), for: .normal)
        ButtonNumber8.setImage(UIImage(named:"Style03-ParkingLot_Button8_highlighted"), for: .highlighted)
        ...
        ButtonNumber9.setImage(UIImage(named:"Style03-ParkingLot_Button9_normal"), for: .normal)
        ButtonNumber9.setImage(UIImage(named:"Style03-ParkingLot_Button9_highlighted"), for: .highlighted)
        ...
        ButtonMultiplication.setImage(UIImage(named:"Style03-ParkingLot_ButtonMultip_normal"), for: .normal)
        ButtonMultiplication.setImage(UIImage(named:"Style03-ParkingLot_ButtonMultip_highlighted"), for: .highlighted)
        ...
        ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonC_normal"), for: .normal)
        ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonC_highlighted"), for: .highlighted)
        ...
        ButtonPosNeg.setImage(UIImage(named:"Style03-ParkingLot_ButtonPosNeg_normal"), for: .normal)
        ButtonPosNeg.setImage(UIImage(named:"Style03-ParkingLot_ButtonPosNeg_highlighted"), for: .highlighted)
        ...
        ButtonPercent.setImage(UIImage(named:"Style03-ParkingLot_ButtonPercent_normal"), for: .normal)
        ButtonPercent.setImage(UIImage(named:"Style03-ParkingLot_ButtonPercent_highlighted"), for: .highlighted)
        ...
        ButtonDivision.setImage(UIImage(named:"Style03-ParkingLot_ButtonDivision_normal"), for: .normal)
        ButtonDivision.setImage(UIImage(named:"Style03-ParkingLot_ButtonDivision_highlighted"), for: .highlighted)
        ...
        ButtonSetup.setImage(UIImage(named:"Style03-ParkingLot__Icon-Setup_normal"), for: .normal)
        ButtonSetup.setImage(UIImage(named:"Style03-ParkingLot__Icon-Setup_highlighted"), for: .highlighted)
        ...
        ButtonHistory.frame = CGRect(x: fullScreenSize.width * 0.205, y: fullScreenSize.height * 0.045,
                                     width: 30, height: 30)
        ButtonHistory.setImage(UIImage(named:"Style03-ParkingLot__Icon-History_normal"), for: .normal)
        ButtonHistory.setImage(UIImage(named:"Style03-ParkingLot__Icon-History_highlighted"), for: .highlighted)
        ...
        LabelShow.textColor = UIColor.init(red: 0.7961, green: 0.8, blue: 0.7843, alpha: 1.0)
        LabelShow.backgroundColor = UIColor.clear
        ...
        LabelShowDetail.textColor = UIColor.init(red: 0.8235, green: 0.6784, blue: 0.1294, alpha: 1.0)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if fullScreenSize.width <= 320 {
            LabelFontAndSize = UIFont(name: "Overpass", size: 75)
            LabelShowDetailFontAndSize = UIFont(name:  "Overpass", size: 25)
        }else if fullScreenSize.width >= 321 && fullScreenSize.width <= 375 {
            LabelFontAndSize = UIFont(name: "Overpass", size: 85)
            LabelShowDetailFontAndSize = UIFont(name:  "Overpass", size: 30)
        }else if fullScreenSize.width >= 376 && fullScreenSize.width <= 621 {
            LabelFontAndSize = UIFont(name: "Overpass", size: 95)
            LabelShowDetailFontAndSize = UIFont(name:  "Overpass", size: 35)
        }else if fullScreenSize.width > 622 {
            LabelFontAndSize = UIFont(name: "Overpass", size: 105)
            LabelShowDetailFontAndSize = UIFont(name:  "Overpass", size: 40)
        }else {
            LabelFontAndSize = UIFont(name: "Overpass", size: 75)
            LabelShowDetailFontAndSize = UIFont(name:  "Overpass", size: 25)
        }
    ...
    func checkACbutton(){
        ...
        if LabelShow.text == "0"{
            ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonAC_normal"), for: .normal)
            ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonAC_highlighted"), for: .highlighted)
        }else{
            ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonC_normal"), for: .normal)
            ButtonClearnAll.setImage(UIImage(named:"Style03-ParkingLot_ButtonC_highlighted"), for: .highlighted)
        }
